...
`auth_user_service` runs from the published Docker Hub image (`tepochtli/fa-auth-m8:2.2.0`). Secrets live in env files — no Vault required.
...
| auth_user_service | [tepochtli/fa-auth-m8:2.2.0](https://hub.docker.com/r/tepochtli/fa-auth-m8) | via Traefik at `/user` |
