...
#: Compatible service-version range. Lower bound is 0.9.8 — the first release that
#: exposes /meta + /ping; earlier 0.9.x have no discovery routes to read.
CONTRACT_RANGE = ">=0.9.8 <0.10.0"
